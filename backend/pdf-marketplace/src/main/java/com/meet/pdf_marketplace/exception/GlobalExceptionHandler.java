...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles requests sent to an endpoint that does not exist.
     * Returns 404 instead of allowing the generic handler to report a misleading 500.
     */
    @ExceptionHandler(NoResourceFoundException.class)
    public ResponseEntity<ErrorResponseDTO> handleMissingEndpoint(
